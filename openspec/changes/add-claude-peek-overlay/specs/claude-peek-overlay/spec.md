...
| claude-peek-overlay.live-screen-during-main-provider-turn | [x] | [x] | [x] | [x] | [x] |
| claude-peek-overlay.peek-follows-latest-main-turn-spawn-only | [x] | [x] | [x] | [x] | [x] |
| claude-peek-overlay.explicit-idle-and-error-states | [x] | [x] | [x] | [x] | [x] |
| claude-peek-overlay.peek-failures-never-affect-the-inference-turn | [x] | [x] | [x] | [x] | [x] |
| claude-peek-overlay.fixed-session-geometry-rendering | [x] | [x] | [x] | [x] | [x] |
| claude-peek-overlay.mirror-files-confined-to-bridge-owned-storage | [x] | [x] | [x] | [x] | [x] |
