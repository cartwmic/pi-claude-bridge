...
- Keep `claude-p` as the default. Do not remove, demote, or automatically replace the maintained `cartwmic/claude-p` fork.
...
- Replacing `claude-p`, changing the default driver, or deleting the maintained fork.
