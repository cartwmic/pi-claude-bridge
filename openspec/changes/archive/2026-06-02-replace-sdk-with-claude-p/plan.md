...
- **Covers:** T4.1–T4.10
- **Action:**
  1. **Scenario gate (T4.1):** run `scripts/run-all-scenarios.sh` (S0–S27). Every scenario green-or-exempted; record results + any exemption (esp. S5) in `SCENARIO_RESULTS.md` + design.md. **This gates completion.**
...
- The full S0–S27 scenario suite passes OR every exception is documented in `SCENARIO_RESULTS.md` + design.md (the replan's hard acceptance bar).
