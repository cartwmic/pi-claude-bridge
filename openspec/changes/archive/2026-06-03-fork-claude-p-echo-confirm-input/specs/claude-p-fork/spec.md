...
|---|---|---|---|---|---|
| claude-p-fork.echo-confirmed-prompt-commit | [x] | [x] | [x] | [x] | [x] |
| claude-p-fork.bounded-retype-on-dropped-prompt | [x] | [x] | [x] | [x] | [x] |
| claude-p-fork.fail-fast-when-the-prompt-cannot-be-confirmed | [x] | [x] | [x] | [x] | [x] |
| claude-p-fork.patch-preserves-the-interactive-tui-driving-model | [x] | [x] | [x] | [x] | [x] |
| claude-p-fork.fork-is-maintained-against-upstream | [x] | [x] | [x] | [x] | [x] |
