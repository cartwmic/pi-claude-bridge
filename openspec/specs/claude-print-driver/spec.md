# claude-print-driver Specification

## Purpose

Direct Claude Code print-mode subprocess invocation, stream protocol normalization, held-tool lifecycle, abort behavior, and isolation guarantees.
