...
## Purpose
Structured output capture through the owning selected driver, including call-shape classification, schema validation, abort semantics, history replay, and resource isolation.
